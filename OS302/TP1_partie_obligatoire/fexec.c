...
/*
	Ce programme prend un lien vers le répertoire d'une commande en argument. Si l'appel de la fonction réussit, alors le processus va fork et 
	attendre l'exécution du fils, qui va exécuter la commande passée en argument. Une fois le processus fils finit, le programme retourne le PID du fils, 
	ainsi que son état au moment de la sortie.
*/
