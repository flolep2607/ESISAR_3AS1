...
//ABNF Gramm file
#define ABNF_RULES "config.abnf" //Fichier contenant les règles de grammaire
#define FIRST_TAG "Config" //Premier Tag pour l'appel récursif
...
/* #### ----DEBUG Algo0 cases  ---*/
/* #### */	#define DEBUG_MATCHED_COMMAND 1//Debug la fonction matched command
/* #### */	#define DEBUG_MATCHED_LOOP 1// Debug la fonction Boucle Algo (et aussi la partie is digit, is *, is (, is [ ?????????????????)
/* #### */	#define DEBUG_MATCHED_PERCENT 0// Debug la fonction Michel_pourcent
/* #### */	#define DEBUG_MATCHED_STRING 1// Debug la fonction Cocktel_Molotov
/* #### */	#define DEBUG_ETAPE2 1// Debug la fin de la boucle (etape2)
...
/* #### */	#define DEBUG_CONSTRUIRE_OUT 1// Display res when construire return
...
/* #### ----DEBUG call and return of main functions ---*/
/* #### */	#define DEBUG_TREE_GROWTH 1//Display Tree at every step in the process ("step" yet to be define)
