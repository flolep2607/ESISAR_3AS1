...
public class VisageRond  {
     ...
     */
    public static final int LARGEUR_MIN = 10;
    /**
    ...
    public void dessiner(Graphics g){
  	...
  	// dessiner la bouche
  	switch(humeur) {
  case HUMEUR.TRANQUILLE:
	g.drawLine(xhg + largeur / 4, yhg + (2*hauteur)/3, xhg + (3*largeur)/4, yhg + (2*hauteur)/3);
    // code block
    break;
  case HUMEUR.TRISTE:
	g.drawLine(xhg + largeur / 4, yhg + (2*hauteur)/3, xhg + (3*largeur)/4, yhg + (2*hauteur)/3);
	g.drawLine(xhg+8 + largeur / 4, yhg + (2*hauteur)/3, xhg + (3*largeur)/4, yhg + (2*hauteur)/3);
  default:
}    // code block
  	// dessiner les yeux
